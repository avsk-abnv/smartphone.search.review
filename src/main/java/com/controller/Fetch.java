...
public class Fetch extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (reqData.equalsIgnoreCase("ping")||reqData.equalsIgnoreCase("ping-homepage")||reqData.equalsIgnoreCase("ping-search")||reqData.equalsIgnoreCase("ping-recommendation")) {
                ...
                if(index == 0 && (reqData.equalsIgnoreCase("ping-recommendation"))){
                    sortedBy_Feature = Recommendation.cluster_IDs;
                }
